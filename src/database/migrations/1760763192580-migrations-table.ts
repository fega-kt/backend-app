...
export class MigrationsTable1760763192580 implements MigrationInterface {
  name = 'MigrationsTable1760763192580';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      ...
      DEFAULT false, "created_by_id" uuid NOT NULL, "updated_by_id" uuid NOT
      NULL, "name" character varying NOT NULL, "code" character varying NOT
      NULL, "path" character varying NOT NULL, CONSTRAINT
    ...
    await queryRunner.query(
      ...
      "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted" boolean NOT NULL
      DEFAULT false, "created_by_id" uuid NOT NULL, "updated_by_id" uuid NOT
      NULL, "language_code" "public"."post_translations_language_code_enum" NOT
      NULL, "title" character varying NOT NULL, "description" character varying
      NOT NULL, "post_id" uuid NOT NULL, CONSTRAINT
      "PK_977f23a9a89bf4a1a9e2e29c136" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "posts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(),
      "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT
      NULL DEFAULT now(), "deleted" boolean NOT NULL DEFAULT false,
      "created_by_id" uuid NOT NULL, "updated_by_id" uuid NOT NULL, "user_id"
      uuid NOT NULL, CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY
      ("id"))`,
    );
    await queryRunner.query(
      ...
      "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted" boolean NOT NULL
      DEFAULT false, "created_by_id" uuid NOT NULL, "updated_by_id" uuid NOT
      NULL, "is_email_verified" boolean NOT NULL DEFAULT false,
      "is_phone_verified" boolean NOT NULL DEFAULT false, "user_id" uuid NOT
      NULL, CONSTRAINT "REL_4ed056b9344e6f7d8d46ec4b30" UNIQUE ("user_id"),
    ...
    await queryRunner.query(
      ...
      "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT
      NULL DEFAULT now(), "deleted" boolean NOT NULL DEFAULT false,
      "created_by_id" uuid NOT NULL, "updated_by_id" uuid NOT NULL, "first_name"
      ...
      character varying, "is_active" boolean NOT NULL DEFAULT false,
